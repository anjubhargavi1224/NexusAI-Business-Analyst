...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside 
        className={`no-print app-sidebar ${isMobileNavOpen ? 'mobile-open' : ''}`}
        style={{
      ...
      >
          ...
          <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon size={18} color={isActive ? '#C084FC' : 'currentColor'} style={{ flexShrink: 0 }} />
        ...
        <div style={{ borderTop: '1px solid rgba(92, 46, 126, 0.2)', paddingTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          >
            <ShieldCheck size={18} color="#C084FC" style={{ flexShrink: 0 }} />
